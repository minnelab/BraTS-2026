...
class RetinaSwinUneTR_Encoder(SwinUNETR):
    ...
    def forward(self, x_in):
        ...
        return [enc0, hidden_states_out[0], hidden_states_out[1], hidden_states_out[2], hidden_states_out[3], hidden_states_out[4]]
